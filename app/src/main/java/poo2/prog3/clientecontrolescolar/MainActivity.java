...
public class MainActivity extends AppCompatActivity {
    private ImageButton mImageBtnMateria;
    private ImageButton mImageBtnEstudiante;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mImageBtnMateria = findViewById(R.id.imgbutton_materia);
        mImageBtnEstudiante = findViewById(R.id.imagebtn_estudiante);
        mImageBtnEstudiante.setEnabled(false);
        mImageBtnMateria.setEnabled(false);
        verificaPermisos();
    }
    ...
    private void verificaPermisos() {
        if (ActivityCompat.checkSelfPermission(this,
            ...
            mImageBtnEstudiante.setEnabled(true);
            mImageBtnMateria.setEnabled(true);
        } else {
    ...
    public void ponLista(View origen) {
        ...
        Intent intent;
        if (idbtnorigen==R.id.imgbutton_materia) {
            intent=new Intent(this, ListMateriaActivity.class);
        }
        else {
